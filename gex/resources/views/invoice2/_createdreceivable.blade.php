                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            {!! Form::model($jobsheet, ['url' => route('invoice.receivable.store', [$jobsheet->id]), 'method' => 'post','class'=>'form-horizontal']) !!}
                                {{ csrf_field() }}

                                @include('invoice.invoiceform', [$jobsheet->id])
...
<div class="modal fade" id="modal-decline{{ $jobsheet->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(['url' => route('invoice.decline.receivable'), 'method' => 'post','class'=>'']) !!}
