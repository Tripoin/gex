                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Create Invoice Reimbursement {{ $jobsheet->code }}</h3>
                        </div>

                            <div class="panel-body">
                            {!! Form::model($jobsheet, ['url' => route('invoice.reimbursement.store', [$jobsheet->id]), 'method' => 'post','class'=>'form-horizontal']) !!}
                                {{ csrf_field() }}

                                @include('invoice.invoiceformrmb', [$jobsheet->id])
...
<div class="modal fade" id="modal-decline{{ $jobsheet->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(['url' => route('invoice.decline.reimbursement'), 'method' => 'post','class'=>'']) !!}
