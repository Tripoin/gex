<div class="row">
    <div class="col-sm-7 col-md-6">
        ...
        <div class="form-group">
            <label class="control-label col-sm-4">BANK ACCOUNT ahahuh</label>
            <div class="col-sm-8">
                <select name="bank_id" class="form-control input-sm">
                    @foreach(App\MasterBank::all() as $bank)
                        <option value="{{ $bank->id }}">{{ $bank->name }} - {{ $bank->cabang }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                ...
                @endphp
                <input type="checkbox" name="ref[]" value="{{ $doc->name.'-'.$ref->ref_no }}"> {{ $doc->name }} - {{ strtoupper($ref->ref_no) }} <br />
                @endforeach
            </div>
        </div>
    </div>
