        ...
        <div class="col-sm-4">
            <table class="table table-borderless table-condensed detail-table no-margin">
                ...
                @php
                    ...
                    $partymeas_unit = App\MasterUnit::find($jobsheet->party_unit_id);
                @endphp
                ...
                <tr>
                    <td>PARTY/MEAS</td>
                    <td>:</td>
                    <td>{{ $jobsheet->partymeas }} x {{ $partymeas_unit->name or '' }}</td>
                </tr>
                <tr>
                    <td>REMARKS</td>
                    <td>:</td>
                            ...
                            <td>
                                <label class="fancy-checkbox">
                                    <!-- <input  type="checkbox" name="charges" class="check-req" value="{{ $receive->id }}" required autofocus="">
                                     -->
                                    @if($receive->rec_invoice_id == null)
                                        {{ Form::checkbox('charges[]', $receive->id, false, ['class' => 'check-req']) }}
                                    @else
