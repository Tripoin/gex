...
$(function(){
    ...
    var table = $('#myTable').DataTable({
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                data: null,
                defaultContent: "-",
                name: 'receivable.term.name',
                render: function (data) {
                    if (data['receivable'][0]['term']['name'] == null){
                        var actions = "-";
                    } else {
                        var actions = data['receivable'][0]['term']['name'];
                    }
            ...
            <a href="/invoice/print/${data['id']}" class="btn btn-primary btn-sm"><i class="fa fa-print"></i></a>`;
                    else
    ...
    $('#myTable').on('click', '.detailJobSheet', function(event){
        ...
        if(arrayTabs.indexOf(jobId) == -1){
            ...
            //load form pd panel
            $.get(`{{ url('/invoice/list/detail') }}`, {id: jobId}, function(result){
