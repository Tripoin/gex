...
$(document).ready(function () {
    $("#unit_charge1").select2();
});
$(document).ready(function () {
    $("#unit_charge2").select2();
});
$(document).ready(function () {
    $("#vendor").select2();
});
...
<script>
    ...
    $(function () {
        ...
        $('[name="eta"]').datepicker({
            ...
            if (etd == "") {
                alert("Please input field etd");
            } else if (etd == formatDate(e.date)) {
                alert("Please input field eta more than etd");
                $('[name="eta"]').val("");
            } else if (new Date(etd.replace(/(\d{2})-(\d{2})-(\d{4})/, "$2/$1/$3")) > new Date(e.date)) {
                alert("Please input field eta more than etd");
                $('[name="eta"]').val("");
            }
        })
...
//            alert("refer etd:" + prev);
            if (eta == formatDate(e.date)) {
                alert("Please input field eta more than etd");
                $('[name="etd"]').val("");
            } else if (new Date(e.date) > new Date(eta.replace(/(\d{2})-(\d{2})-(\d{4})/, "$2/$1/$3"))) {
                alert("Please input field eta more than etd");
                $('[name="etd"]').val("");
            }
        })
