...
<script type="text/javascript" src="{{ asset('vendor/bootstrap/js/bootstrap-datepicker.js') }}" charset="UTF-8"></script>
    <script>
    $(document).ready(function() { $("#rec_terms0").select2(); });
    $(document).ready(function() { $("#rec_terms1").select2(); });
    $(document).ready(function() { $("#rec_terms2").select2(); });
    $(document).ready(function() { $("#rec_customers0").select2(); });
    $(document).ready(function() { $("#rec_customers1").select2(); });
    $(document).ready(function() { $("#rec_customers2").select2(); });
    $(document).ready(function() { $("#rec_documents0").select2(); });
    $(document).ready(function() { $("#rec_documents1").select2(); });
    $(document).ready(function() { $("#rec_documents2").select2(); });

    $(document).ready(function() { $("#rmb_terms0").select2(); });
    $(document).ready(function() { $("#rmb_terms1").select2(); });
    $(document).ready(function() { $("#rmb_terms2").select2(); });
    $(document).ready(function() { $("#rmb_customers0").select2(); });
    $(document).ready(function() { $("#rmb_customers1").select2(); });
    $(document).ready(function() { $("#rmb_customers2").select2(); });
    $(document).ready(function() { $("#rmb_documents0").select2(); });
    $(document).ready(function() { $("#rmb_documents1").select2(); });
    $(document).ready(function() { $("#rmb_documents2").select2(); });
...
$(function(){
    ...
    //add terms
    $('.tab-content').on('click', '.add-terms', function(event){
        event.preventDefault();
        index_term = parseInt($('.term-charge .terms-group').last().attr('index'))+1;
        console.log(index_term);
        var elem = $(`<div class="terms-group" index="${index_term}">
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">

                        {!! Form::hidden('rec_marketing_id[${index_term}]', 0) !!}

                        <div class="col-sm-3">
                            <label>TERMS OF PAYMENT</label>
                            {!! Form::select('rec_term_id[${index_term}]', 
                            [''=>'']+App\MasterTerm::pluck('name','id')->all(),old('rec_term_id'), 
                            ['class'=>'form-control input-sm term', 'id'=>'rec_terms1','required']) !!}
                        </div>
                        <div class="col-sm-3">
                            <label>BILL TO</label>
                            {!! Form::select('rec_customer_id[${index_term}]', [''=>'']+App\MasterCustomer::pluck('name','id')->all(),old('rec_customer_id'), ['class'=>'form-control input-sm', 'id'=>'rec_customers1','required']) !!}
                        </div>
                        <div class="col-sm-6 text-right">
                            <label></label>
                            <div>
                                <button class="btn btn-sm btn-danger rem-terms" type="button"><i class="fa fa-minus fa-fw"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 charge-group">
                    <div class="form-group">
                        ...
                        {!! Form::hidden('rec_id[${index_term}][]', 0) !!}
                        
                        <div class="col-sm-3">
                            <label>DETAIL</label>
                            <div class="input-group">
                                {!! Form::select(
                                    'rec_document_id[${index_term}][]', 
                                    [''=>'']+App\MasterDocument::where('type','payable')->pluck('name','id')->all(),
                                    old('rec_document_id'), 
                                    ['class'=>'form-control input-sm term','required']) 
                                !!}
                        ...
                        <div class="col-sm-2">
                            <label>CHARGE</label>
                            {!! Form::select('rec_charge_type[${index_term}][]', [
                                '1'=>'CHARGES',
                                '2'=>'FREIGHT CHARGES',
                                '3'=>'FREIGHT CHARGES - COLLECT',
                            ],old('rec_charge_type'), ['class'=>'form-control input-sm term','required']) !!}
                        </div>
                        <div class="col-sm-1">
                            <label>TAX</label>
                            {!! Form::select('rec_tax[${index_term}][]', [
                                '1'=>'PPN1',
                                '2'=>'PPN2',
                                '3'=>'NON PPN',
                            ],old('rec_tax'), ['class'=>'form-control input-sm term','required']) !!}
                        </div>
                        <div class="col-sm-1">
                            <label>QTY</label>
                            {!! Form::text('rec_quantity[${index_term}][]',null, [
                        ...
                        <div class="col-sm-1 no-padding-right">
                            <label>UNIT</label>
                            {!! Form::select('rec_unit_id[${index_term}][]', [''=>'']+App\MasterUnit::pluck('name','id')->all(),old('rec_unit_id'), ['class'=>'form-control input-sm unit','required']) !!}
                        </div>
                        <div class="col-sm-1">
                            <label>CURRENCY</label>
                            {!! Form::select('rec_currency[${index_term}][]', [
                                '1'=>'IDR',
                                '2'=>'USD',
                            ],old('rec_currency'), ['class'=>'form-control input-sm currency','required']) !!}
                        </div>
                        <div class="col-sm-1 no-padding-left no-padding-right">
                            <label>AMOUNT</label>
                            {!! Form::text('rec_price[${index_term}][]',old('rec_price'), [
                        ...
                        <div class="col-sm-2 text-right">
                            ...
                            <input type="text" class="form-control input-sm text-right subtotal" id="rec_total" value="00.00" readonly param="1">
                        </div>
                    </div>
                </div>
            </div>
        ...
        elem.insertBefore($(this).parents('.terms-group').siblings('.total-group'));
        index_term++;
        index_charges++;
    });

    //remove terms
    $('.tab-content').on('click', '.rem-terms', function(){
        $(this).parents('.terms-group').remove();
    });

    //empty terms
    $('.tab-content').on('click', '.empty-terms', function(){
        $(this).parents('.terms-group').find('#rec_terms').val('');
        $(this).parents('.terms-group').find('#rec_bill').val('');

        $(this).parents('.terms-group').find('#rec_documents').val('');
        $(this).parents('.terms-group').find('#rec_charge').val('');
        $(this).parents('.terms-group').find('#rec_tax').val('');
        $(this).parents('.terms-group').find('#rec_qty').val('');
        $(this).parents('.terms-group').find('#rec_unit').val('');
        $(this).parents('.terms-group').find('#rec_curr').val('');
        $(this).parents('.terms-group').find('#rec_price').val('');
        $(this).parents('.terms-group').find('#rec_total').val('');
    });

    //add charge
    $('.tab-content').on('click', '.add-charge', function(event){
        event.preventDefault();
        var index_term = $(this).closest('.terms-group').attr('index');
        var elem = `<div class="form-group">
            <div class="col-sm-3">
                ...
                <div class="input-group">
                    {!! Form::select(
                        ...
                        [''=>'']+App\MasterDocument::where('type','payable')->pluck('name','id')->all(),
                        old('rec_document_id'), 
                        ['class'=>'form-control input-sm term','id'=>'rec_documents${index_term}','required']) 
                    !!}
                    <span class="input-group-btn"><button class="btn btn-sm btn-danger rem-charge" type="button"><i class="fa fa-minus"></i></button></span>
                </div>
            </div>
            <div class="col-sm-2">
                {!! Form::select('rec_charge_type[${index_term}][]', [
            ...
            <div class="col-sm-1">
                {!! Form::text('rec_quantity[${index_term}][]',old('rec_quantity'), [
                    'class'=>'form-control input-sm qty',
            ...
            <div class="col-sm-1 no-padding-right">
                {!! Form::select('rec_unit_id[${index_term}][]', [''=>'']+App\MasterUnit::pluck('name','id')->all(),old('rec_unit_id'), ['class'=>'form-control input-sm unit']) !!}
            </div>
            <div class="col-sm-1">
                {!! Form::select('rec_currency[${index_term}][]', [
                    '1'=>'IDR',
        ...
        $(this).parents('.charge-group').append(elem);
    });

    //remove charge
    $('.tab-content').on('click', '.rem-charge', function(){
        $(this).parents('.form-group').remove();
    });

    $('.tab-content').on('click', '.empty-charge', function(){
        $(this).parents('.form-group').find('#rec_documents').val('');
        $(this).parents('.form-group').find('#rec_charge').val('');
        $(this).parents('.form-group').find('#rec_tax').val('');
        $(this).parents('.form-group').find('#rec_qty').val('');
        $(this).parents('.form-group').find('#rec_unit').val('');
        $(this).parents('.form-group').find('#rec_curr').val('');
        $(this).parents('.form-group').find('#rec_price').val('');
        $(this).parents('.form-group').find('#rec_total').val('');
    });

    //add element terms reimbursement
    function addTermsReimburse(selector, classButton, option = 'add'){
        //jika option == reset, tambah class atau attribut disabled pd input/select/button
        var classDisabled = (option == 'reset') ? 'disabled' : '';
        rmb_index_term = parseInt($('.term-rmb .term-reimbursement').last().attr('index'))+1;

        var elem = $(`<div class="terms-group term-reimbursement" index="${rmb_index_term}">
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        
                        {!! Form::hidden('rmb_marketing_id[${rmb_index_term}]', 0) !!}
                        
                        <div class="col-sm-3">
                            <label>TERMS OF PAYMENT</label>
                            {!! Form::select('rmb_term_id[${rmb_index_term}]', [''=>'']+App\MasterTerm::pluck('name','id')->all(),old('rmb_term_id'), ['class'=>'form-control input-sm input-reimburse term','id'=>'','required']) !!}
                        </div>
                        <div class="col-sm-3">
                            <label>BILL TO</label>
                            {!! Form::select('rmb_customer_id[${rmb_index_term}]', [''=>'']+App\MasterCustomer::pluck('name','id')->all(),old('rmb_customer_id'), ['class'=>'form-control input-sm input-reimburse','id'=>'','required']) !!}
                        </div>
                        <div class="col-sm-6 text-right">
                            <label></label>
                            <div>
                                <button class="btn btn-sm ${classButton.type} ${classButton.name} ${classDisabled}" type="button"><i class="fa ${classButton.icon} fa-fw"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 charge-group">
                    <div class="form-group">
                        ...
                        {!! Form::hidden('rmb_id[${rmb_index_term}][]', 0) !!}
                        
                        <div class="col-sm-3">
                            <label>DETAIL</label>
                            <div class="input-group">
                                {!! Form::select(
                                    'rmb_document_id[${rmb_index_term}][]', 
                                    [''=>'']+App\MasterDocument::pluck('name','id')->all(),
                                    old('rmb_document_id'), 
                                    ['class'=>'form-control input-sm input-reimburse','id'=>'','required']) 
                                !!}
                                <span class="input-group-btn"><button class="btn btn-sm btn-primary add-reimburse ${classDisabled}" type="button"><i class="fa fa-plus"></i></button></span>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <label>CHARGE</label>
                            <input type="text" class="form-control input-sm" value="B. PENGGANTIAN" readonly>
                        </div>
                        <div class="col-sm-1">
                            <label>QTY</label>
                            {!! Form::text('rmb_quantity[${rmb_index_term}][]',old('rmb_quantity'), [
                            'class'=>'form-control input-sm input-reimburse rmb_qty','placeholder'=>'Qty','required'
                            ]) !!}
                            <label class="x-mark">X</label>
                        </div>
                        <div class="col-sm-1 no-padding-right">
                            <label>UNIT</label>
                            {!! Form::select('rmb_unit_id[${rmb_index_term}][]', [''=>'']+App\MasterUnit::pluck('name','id')->all(),old('rmb_unit_id'), ['class'=>'form-control input-sm input-reimburse','id'=>'']) !!}
                        </div>
                        <div class="col-sm-1">
                            <label>CURR</label>
                            {!! Form::select('rmb_currency[${rmb_index_term}][]', [
                                        '1'=>'IDR','2'=>'USD',],old('rmb_currency'), ['class'=>'form-control input-sm input-reimburse rmb_currency','required']) !!}
                        </div>
                        <div class="col-sm-1 no-padding-left no-padding-right">
                            <label>AMOUNT</label>
                            {!! Form::text('rmb_price[${rmb_index_term}][]',old('rmb_price'), [
                        ...
                        <div class="col-sm-3 text-right">
                            ...
                            <input type="text" class="form-control input-sm text-right rmb_subtotal" id="email" value="0,00" readonly param="1">
                        </div>
                    </div>
                </div>
            </div>
        ...
        if(option = 'add'){
            return elem.insertBefore(selector);
        }
    ...
    //add terms reimburse
    $('.tab-content').on('click', '.add-terms-reimburse', function(event){
        event.preventDefault();

        //kalau ada class disabled, ga bs tambah element
        ...
        //class untuk button & icon dinamis
        var classButton = {
            name : "rem-terms-reimburse",
            type : "btn-danger",
            icon : "fa-minus"
        };

        var selector = $(this).parents('.terms-group').siblings('.total-group');
        addTermsReimburse(selector, classButton);
    });

    $('.tab-content').on('click', '.empty-terms-reimburse', function(){
        $(this).parents('.terms-group').find('#rmb_terms').val('');
        $(this).parents('.terms-group').find('#rmb_bill').val('');

        $(this).parents('.terms-group').find('#rmb_documents').val('');
        // $(this).parents('.terms-group').find('#rmb_charge').val('');
        // $(this).parents('.terms-group').find('#rmb_tax').val('');
        $(this).parents('.terms-group').find('#rmb_qty').val('');
        $(this).parents('.terms-group').find('#rmb_unit').val('');
        $(this).parents('.terms-group').find('#rmb_curr').val('');
        $(this).parents('.terms-group').find('#rmb_price').val('');
        $(this).parents('.terms-group').find('#rmb_total').val('');
    });

    //remove terms reimburse
    $('.tab-content').on('click', '.rem-terms-reimburse', function(){
        $(this).parents('.terms-group').remove();
    });

    //add reimbursement
    $('.tab-content').on('click', '.add-reimburse', function(event){
        event.preventDefault();
        ...
        var rmb_index_term =$(this).closest('.term-reimbursement').attr('index');
        ...
        var elem = `<div class="form-group">
            <div class="col-sm-3">
                ...
                <div class="input-group">
                    {!! Form::select(
                        ...
                        ['class'=>'form-control input-sm input-reimburse','id'=>'','required']) 
                    !!}
                    <span class="input-group-btn"><button class="btn btn-sm btn-danger rem-reimburse" type="button"><i class="fa fa-minus"></i></button></span>
                </div>
            </div>
            <div class="col-sm-2">
                <input type="text" class="form-control input-sm" value="B. PENGGANTIAN" readonly>
            ...
            <div class="col-sm-3 text-right">
                <input type="text" class="form-control input-sm text-right rmb_subtotal" value="0.00" readonly param="1">
            </div>
        </div>`;

        //$(this).parents('.row').siblings('.charge-wrap').find('.charge-group').append(elem);
        $(this).parents('.charge-group').append(elem);
    });
    

    //remove reimbursement
    $('.tab-content').on('click', '.rem-reimburse', function(){
        $(this).parents('.form-group').remove();
    });

    $('.tab-content').on('click', '.empty-reimburse', function(){
        $(this).parents('.form-group').find('#rmb_documents').val('');
        // $(this).parents('.terms-group').find('#rmb_charge').val('');
        // $(this).parents('.terms-group').find('#rmb_tax').val('');
        $(this).parents('.form-group').find('#rmb_qty').val('');
        $(this).parents('.form-group').find('#rmb_unit').val('');
        $(this).parents('.form-group').find('#rmb_curr').val('');
        $(this).parents('.form-group').find('#rmb_price').val('');
        $(this).parents('.form-group').find('#rmb_total').val('');
    });

    //add R/C
    $('.tab-content').on('click', '.add-rc', function(event){
        event.preventDefault();
        ...
        var elem = `<div class="form-group">
            ...
            <div class="col-sm-2">
                <div class="input-group">
                    {!! Form::select(
                            ...
                            [''=>'']+App\MasterDocument::pluck('name','id')->all(),
                            old('document_id'), 
                            ['class'=>'form-control input-sm binding_charge','id'=>'','required']) 
                        !!}
                    <span class="input-group-btn"><button class="btn btn-sm btn-danger rem-rc" type="button"><i class="fa fa-minus"></i></button></span>
                </div>
            </div>
            <div class="col-sm-2 no-padding-right no-padding-left">
                {!! Form::select('rc_vendor_id[]', [''=>'']+App\MasterVendor::pluck('name','id')->all(),old('vendor_id'), ['class'=>'form-control input-sm','id'=>'','required']) !!}
            </div>
            <div class="col-sm-1">
            ...
            <div class="col-sm-1">
                {!! Form::select('rc_unit_id[]', [''=>'']+App\MasterUnit::pluck('name','id')->all(),old('unit_id'), ['class'=>'form-control input-sm input-reimburse','id'=>'','required']) !!}
            </div>
            <div class="col-sm-1">
                {!! Form::select('rc_currency[]', [
                        '1'=>'IDR',
                        '2'=>'USD',
                    ],old('currency'), ['class'=>'form-control input-sm rc_currency','required']) !!}
            </div>
            <div class="col-sm-2">
                {!! Form::text('rc_price[]',old('price'), [
                        'class'=>'form-control input-sm rc_ammount',
                        'placeholder'=>'Amount','required'
                    ]) !!}
            </div>
            <div class="col-sm-2 text-right">
    ...
    //remove R/C
    $('.tab-content').on('click', '.rem-rc', function(){
        $(this).parents('.form-group').remove();
    });

    $('.tab-content').on('click', '.empty-rc', function(){
        $(this).parents('.form-group').find('#rc_documents').val('');
        $(this).parents('.form-group').find('#rc_charge').val('');
        $(this).parents('.form-group').find('#rc_tax').val('');
        $(this).parents('.form-group').find('#rc_qty').val('');
        $(this).parents('.form-group').find('#rc_unit').val('');
        $(this).parents('.form-group').find('#rc_curr').val('');
        $(this).parents('.form-group').find('#rc_price').val('');
        $(this).parents('.form-group').find('#rc_total').val('');
    });
