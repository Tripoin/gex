                ...
                <div class="col-sm-8">
                    <select class="form-control input-sm options_doc" id="poo" name="poo_id" required="required">
                        ...
                        foreach ($listPort as $list) {
                            if (isset($jobsheet->poo_id)) {
                                echo '<option value="' . $list->id . '" selected="selected">' . $list->city . ' - ' . $list->nick_name . '</option>';
                            } else {
                                echo '<option value="' . $list->id . '">' . $list->city . ' - ' . $list->nick_name . '</option>';
                            }
                        }
                        ?>
                    </select>
