...
$(function(){
    ...
    $('.add-doc').click(function(){
        var elem = `<div class="form-group">
            ...
            <div class="col-sm-8">
                <input class="form-control input-sm input-doc text-big" type="text" placeholder="References Number" name="ref_no[]">
            </div>
        </div>`;
...
$(function(){
    ...
    $('.tab-content').on('click', '.add-charge', function(event){
        ...
        var elem = `<div class="form-group ">
            ...
            <input type="hidden" name="payable_id[]" value="0">

            <div class="col-sm-3 no-padding-right">
                <div class="input-group">
                    {!! Form::select('document_id[]', [''=>'']+App\MasterDocument::pluck('name','id')->all(), null, ['class'=>'form-control input-sm','id'=>'']) !!}
            ...
            <div class="col-sm-2 no-padding-right">
                {!! Form::select('vendor_id[]', [''=>'']+App\MasterVendor::pluck('name','id')->all(), null, ['class'=>'form-control input-sm','id'=>'']) !!}
            </div>
            <div class="col-sm-1">
                {!! Form::text('quantity[]',null,['class'=>'form-control input-sm qty','placeholder'=>'Qty']) !!}
                <label class="x-mark">X</label>
            </div>
            <div class="col-sm-1">
                {!! Form::select('unit_id[]', [''=>'']+App\MasterUnit::pluck('name','id')->all(), null, ['class'=>'form-control input-sm','id'=>'']) !!}
            </div>
            <div class="col-sm-1">
                {!! Form::select('currency[]', ['1'=>'IDR','2'=>'USD',],null, ['class'=>'form-control input-sm currency']) !!}
            </div>
            <div class="col-sm-2 no-padding-left no-padding-right">
                {!! Form::text('price[]', null, ['class'=>'form-control input-sm text-right text-money ammount','placeholder'=>'Amount','required'=>'true']) !!}
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="col-sm-3">
                            ...
                            {!! Form::select('rmb_term_id[${rmb_index_term}]', [''=>'']+App\MasterTerm::pluck('name','id')->all(),old('rmb_term_id'), ['class'=>'form-control input-sm input-reimburse term','id'=>'']) !!}
                        </div>
                        <div class="col-sm-3">
                            <label>BILL TO</label>
                            {!! Form::select('rmb_customer_id[${rmb_index_term}]', [''=>'']+App\MasterCustomer::pluck('name','id')->all(),old('rmb_customer_id'), ['class'=>'form-control input-sm input-reimburse','id'=>'']) !!}
                        </div>
                ...
                <div class="col-sm-12 charge-group">
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            ...
                            'class'=>'form-control input-sm input-reimburse rmb_qty','placeholder'=>'Qty'
                            ]) !!}
                            <label class="x-mark">X</label>
                        </div>
                        ...
                        <div class="col-sm-1">
                            ...
                            {!! Form::select('rmb_currency[${rmb_index_term}][]', [
                                        '1'=>'IDR','2'=>'USD',],old('rmb_currency'), ['class'=>'form-control input-sm input-reimburse rmb_currency']) !!}
                        </div>
        ...
        var elem = `<div class="form-group">
            ...
            <div class="col-sm-1 no-padding-right">
                <div class="input-group">
                    {!! Form::select('rc_type[]', [
                        'marketing'=>'Marketing',
                        'pricing'=>'Pricing',
                    ],'pricing', ['class'=>'form-control input-sm']) !!}
                </div>
            </div>
            <div class="col-sm-2">
                <div class="input-group">
            ...
            <div class="col-sm-1">
                {!! Form::select('rc_currency[]', [
                        '1'=>'IDR',
                        '2'=>'USD',
                    ],old('currency'), ['class'=>'form-control input-sm rc_currency']) !!}
            </div>
            <div class="col-sm-2">
