										...
										<div class="table-responsive">
											...
											<div class="row">
												...
												<div class="col-sm-4 pull-right">
													<a href="{!! route('payable.report.'.$controllerRole, ['isExportExcel'=>1, 'report_from'=>$reportForm, 'report_to'=>$reportTo]) !!}">Excel</a>
													<a href="{!! route('payable.report.'.$controllerRole, ['isExportPDF'=>1, 'report_from'=>$reportForm, 'report_to'=>$reportTo]) !!}">PDF</a>
												</div>
											</div>
