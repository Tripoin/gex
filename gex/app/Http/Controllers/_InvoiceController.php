...
class _InvoiceController extends Controller
{
    ...
    public function receivable_show(Request $request, Datatables $datatables, $id, $rec_id)
    {
        ...
        return view('invoice.receivable.show', compact('invoice','jobsheet','charges','references','receivables','max','tot','rec_total_price','rec_total_tax_idr','rec_total_tax_usd','rec_total_price_usd','rmb_total_price_idr'));
    }
